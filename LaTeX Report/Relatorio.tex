...
O Messenger implementa um mensageiro simples com servidor e cliente via TCP. O servidor gera um par de chaves RSA e guarda as mensagens no servidor, cifradas através de um esquema híbrido: o conteúdo é protegido com Fernet (simétrico) e a chave Fernet é cifrada com a chave pública RSA. O cliente comunica com o servidor através de comandos em JSON para enviar, listar, descarregar e apagar mensagens, garantindo que apenas participantes podem aceder ao conteúdo. Inclui ainda criação de backups cifrados (simétricos com palavra‑passe ou assimétricos com RSA), reforçando boas práticas de proteção de dados.
